...
버전관리를 시작할려면 원하는 폴더 (=프로젝트 폴더)에서 git init 명령어를 실행하면 됩니다. Git 사용법에 대해서는 한글 매뉴얼을 참고하시길 바랍니다. <https://git-scm.com/book/ko/v2>

(RStudio에서는 Git 사용여부에 대한 설정이 있고 이를 이용해서 greaphic user interface로 사용할 수 도 있습니다.)
